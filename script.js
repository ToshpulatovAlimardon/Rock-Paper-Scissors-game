...
rpsAll.forEach((item, index) => {
    item.onclick = () => {
        ...
        if (item.classList.contains("guest-player")) {
            return;
        } else if (item.classList.contains("home-active")) {
            return;
        } else {
                        ...
                        setTimeout(() => {
                            ...
                            if (rpsAllCopy[index] === guestPlayer) {
                                ...
                                setTimeout(() => {
                                    ...
                                    playZone
                                        .querySelector(".guest-player")
                                        .classList.remove("home-active");
                                    setTimeout(() => {
                                        playZone
                                            .querySelector(".guest-player")
                                            .insertAdjacentHTML(
                            ...
                            <div class="win-title">
                            <h1>${
                                rpsAllCopy[index] === rpsAllCopy[0] &&
                                guestPlayer === rpsAllCopy[1]
                                    ? "you lose"
                                    : rpsAllCopy[index] === rpsAllCopy[1] &&
                                      guestPlayer === rpsAllCopy[2]
                                    ? "you lose"
                                    : rpsAllCopy[index] === rpsAllCopy[2] &&
                                      guestPlayer === rpsAllCopy[0]
                                    ? "you lose"
                                    : "you win"
                            }</h1>
                            <button onclick="location.reload()">play again</button>
                            ...
                            `
                                        ...
                                        document.querySelector(".win-title h1")
                                            .textContent ===
                                        "you win".toLowerCase()
                                            ? localStorage.setItem(
                                                  "score",
                                                  JSON.stringify(scoreNum + 1)
                                              )
                                            : "";
                                        document.querySelector(".win-title h1")
                                            .textContent ===
